...
def detect(save_img=False):
    ...
    pd = pds.read_csv("/opt/camera-sc2/master_key-ao-new.csv") #master key berisikan kunci untuk setiap model bemper (jenis, warna, dll)
                    ...
                    if send:
                        ...
                        if centers2:
                            ...
                            try:
                                ...
                                bumper_detected = 'bumper_detected.csv'
