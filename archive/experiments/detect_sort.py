    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                detections = [Detection(bbox, score, classe, feature) for bbox, score, classe, feature in zip(bboxes, scores, classes, features)]
                ...
                for track in tracker.tracks:
                    ...
                    label = f'{names[int(cls)]} {conf:.2f} {txt}'
                    ...
                    cv2.putText(im0, label, org, cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 1)
...
if __name__ == '__main__':
    ...
    process1 = multiprocessing.Process(target=get_aa)
    process2 = multiprocessing.Process(target=get_data)
